...
function Navbar() {
    ...
    return (
        <div className='max-w-screen-md mx-auto p-5 flex items-center justify-between '>
            ...
            <div>
                <a href="https://drive.google.com/file/d/1cLzIYbQONICu6-JWMAocl7UktRYmhLZD/view?usp=drive_link" target='blank'><Button className="bg-sky-400 text-white hover:bg-sky-500 hover:text-white dark:bg-sky-400 dark:text-white rounded-full transform transition-transform duration-300 hover:scale-110 hover:shadow-lg px-4 py-1 text-xs sm:px-6 sm:py-3 sm:text-base"><FileUser />Resume</Button></a>
            </div>
        </div>
    )
}
